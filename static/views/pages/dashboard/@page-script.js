jQuery(function ($) {
  ...
  if (displayed < 2) {
    ...
    $.aceToaster.add({
      placement: "tc",
      body:
        "<div class='py-2 pl-1 pr-3 d-flex '>\
      ...
      bodyClass:
        "border-1 border-t-0 brc-secondary-l2 text-dark-tp3 text-120 p-2",
      headerClass: "d-none",
    });
  }
  ...
  $("#tasks input[type=checkbox]").on("change", function () {
    $(this)
      .closest("#tasks > div")
      .toggleClass("bgc-secondary-l4", this.checked)
      .find("label")
      .toggleClass("line-through text-grey-d2", this.checked);
  });
  ...
  $(trafficSourceCanvas)
    ...
    .after(
      "<div id='traffic-source-legends' class='piechart-legends text-95 text-secondary-d3'>" +
        trafficSourcePieChart.generateLegend() +
        "</div>"
    );
          ...
          custom: function (tooltipModel) {
            ...
            $(canvas)
              .tooltip({
                placement: "bottom",
                template:
                  '<div class="tooltip" role="tooltip"><div class="brc-info-d2 arrow"></div><div class="bgc-info-d2 tooltip-inner text-600 text-110"></div></div>',
              })
              .tooltip("show")
