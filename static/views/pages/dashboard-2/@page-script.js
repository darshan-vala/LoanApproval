jQuery(function ($) {
  ...
  $(".sidebar .fa-exclamation-triangle")
    .removeClass("text-danger-m2")
    .addClass("text-yellow-m3");
  $(".sidebar .badge-primary")
    .removeClass("badge-primary")
    .addClass("bgc-success-m1 text-dark-d2");

  // show tooltips
  if (!("ontouchstart" in window))
    $('[data-toggle="tooltip"]').tooltip({
      template:
        '<div class="tooltip" role="tooltip"><div class="brc-secondary arrow"></div><div class="bgc-secondary-d2 tooltip-inner text-600 text-110 pt-15 pb-2"></div></div>',
      placement: "left",
      container: "body",
    });
  ...
  // Welcome message
  if (
    localStorage.getItem("welcome.ace") !== "displayed" &&
    ...
    $.aceToaster.add({
      ...
      className:
        "bgc-green-tp3 text-white shadow overflow-hidden border-0 p-1 radius-3px",
  ...
  $(window).on("load", function () {
    var _scroller = document.querySelector(
      '#conversations div[class*="ace-scroll"]'
    );
    if (_scroller)
  ...
  $("#tasks input[type=checkbox]").on("change", function () {
    $(this)
      .closest("label")
      .find(".task-title")
      .toggleClass("line-through", this.checked);
  });
          ...
          custom: function (tooltipModel) {
            ...
            if (tooltipModel.body) {
              title =
                ...
                ": " +
                Number(tooltipModel.body[0].lines[0]).toLocaleString();
            }
            ...
            $(canvas)
              .tooltip({
                placement: "bottom",
                template:
                  '<div class="tooltip" role="tooltip"><div class="brc-info-d2 arrow"></div><div class="bgc-info-d2 tooltip-inner font-bolder text-110"></div></div>',
              })
              .tooltip("show")
        ...
        datasets: [
          {
            label: "Task Progress",
            data: [val, 100 - val],
            backgroundColor: ["#6775b3", "#e1e3f0"],
            hoverBackgroundColor: ["#6775b3", "#e1e3f0"],
            borderWidth: 0,
          },
        ],
      },
  ...
  // var googleBusinessPieChart = new Chart(
  //   googleBusinessCanvas,
  //   config_traffic_sources
  // );
  ...
  //   .parent()
  //   .after(
  //     "<div id='google-business-legends' class='piechart-legends text-95 text-secondary-d3'>" +
  ...
  // var facebookPagePieChart2 = new Chart(
  //   facebookPageCanvas2,
  //   config_traffic_sources
  // );
  ...
  //   .parent()
  //   .after(
  //     "<div id='facebook-page-legends2' class='piechart-legends text-95 text-secondary-d3'>" +
  ...
  // var yelpAccountPieChart3 = new Chart(
  //   yelpAccountCanvas3,
  //   config_traffic_sources
  // );
  ...
  if (trafficSourceChart_Legends_Wrapped) {
    ...
    demographicsChart.height = parseInt(
      demographicsChart.parentNode.parentNode.clientHeight * 0.66
    );
  }
      ...
      datasets: [
        {
          label: "User Devices",
          data: [45, 18, 37],
          backgroundColor: ["#ebab40", "#1aa1ab", "#4aaceb"],
        },
      ],
  ...
  var userDevicePieChart = new Chart(
    document.getElementById("user-device-chart"),
    config_user_devices
  );
  ...
  $(document.getElementById("user-device-chart"))
    .parent()
    .after(
      "<div id='user-device-legends' class='piechart-legends text-95 text-secondary-d3'>" +
        userDevicePieChart.generateLegend() +
        "</div>"
    );
