...
if (location.protocol == "file:" && (!window.jQuery || !window.bootstrap)) {
  alert(
    "jQuery, Bootstrap and other libraries are not available!\n\nPlease run `npm install` to install them first."
  );
}
...
(function ($, undefined) {
  ...
  $(".sidebar .badge[title]").tooltip({
    template:
      '<div class="tooltip" role="tooltip"><div class="arrow brc-primary-d2"></div><div class="bgc-primary-d2 tooltip-inner font-bolder p-2"></div></div>',
    placement: "right",
    boundary: "viewport",
  });
  ...
  $(".sidebar:not(.sidebar-h) .btn[title]").tooltip({
    template:
      '<div class="tooltip" role="tooltip"><div class="arrow brc-default-d2"></div><div class="bgc-default-d2 tooltip-inner text-110 font-bolder p-2"></div></div>',
    placement: "top",
    boundary: "viewport",
  });
  ...
  $(".sidebar.sidebar-h .btn[title]").tooltip({
    template:
      '<div class="tooltip" role="tooltip"><div class="arrow brc-dark"></div><div class="bgc-dark tooltip-inner text-110 font-bolder p-2"></div></div>',
    placement: "bottom",
    boundary: "viewport",
  });
  ...
  $("#id-navbar-fixed").on("change", function () {
    document
      ...
      .classList.toggle("navbar-fixed", this.checked);
  });
  //fixed sidebar
  $("#id-sidebar-fixed").on("change", function () {
    document
      .querySelector(".sidebar")
      .classList.toggle("sidebar-fixed", this.checked);
  });
  //fixed footer
  ...
  $("#id-push-content").on("change", function () {
    document
      .querySelector(".sidebar")
      .classList.toggle("sidebar-push", this.checked);
  });
  ...
  styleEl.innerHTML =
    ".flex-equal-sm > * {flex: 0 1 1% !important;}\
  ...
  function resetSidebarColors($sidebar) {
    $sidebar
      .removeClass(function (index, className) {
        ...
        if (matchedClasses)
          matchedClasses = matchedClasses.filter(function (str) {
            return !/sidebar-fixed|sidebar-visible|sidebar-backdrop|sidebar-top|sidebar-h|sidebar-push/.test(
              str
            );
          });
    ...
    $sidebar
      .find(".nav")
      .removeClass(
        "has-active-border active-on-top active-on-right has-active-arrow"
      );

    if (currentBodyTheme == "auto")
    ...
    $sidebar
      .find(".sidebar-shortcuts-mini")
      .parent()
      .find(".btn")
      .removeClass(function (index, className) {
        var matchedClasses = className.match(
          /(^|\s)(btn-|radius-|border-|brc-|text-|opacity-)\S+/g
        );
        if (matchedClasses)
          matchedClasses = matchedClasses.filter(function (str) {
    ...
    $sidebar
      .find(".fa-exclamation-triangle, .fa.fa-search , .fa.fa-microphone")
      .removeClass(function (index, className) {
    ...
    if (window.currentLayout == 2) {
      $sidebar
        .find(
          ".navbar-brand, .navbar-brand span:last, .fa-leaf, img, #id-user-info a, #id-user-info div"
        )
        .removeClass(function (index, className) {
          var matchedClasses = className.match(
            /(^|\s)(bgc-|brc-|text-|opacity-)\S+/g
          );
          return (matchedClasses || []).join("");
        });

      $sidebar
        .find("#id-user-menu a, #id-user-menu a i")
        .removeClass(function (index, className) {
          var matchedClasses = className.match(
            /(^|\s)(btn-|bgc-|brc-|text-|opacity-|shadow-|border-|radius-)\S+/g
          );
          return (matchedClasses || []).join("");
        });
    }
  ...
  sidebarMatchings.light = {
    ...
    "content-white": true,
    "alert-2":
      'This sidebar theme is more suitable for <a href="' +
      $('.sidebar .nav-link[href*="dashboard"]').attr("href") +
      '" class="btn btn-xs btn-outline-white px-1 border-0">Dashboard 1</a>',

    "user-menu":
      "btn-light-blue btn-brc-white btn-h-blue btn-a-blue radius-round border-2 shadow-sm",
  ...
  sidebarMatchings.lightblue = jQuery.extend({}, sidebarMatchings.light, {
    ...
    nav: "",
    shortcuts: [
      "btn btn-outline-primary btn-bgc-white border-2 btn-text-success btn-h-success btn-a-success",
      "btn btn-outline-primary btn-bgc-white border-2 btn-text-info btn-h-info btn-a-info",
      "btn btn-outline-primary btn-bgc-white border-2 btn-text-orange btn-h-orange btn-a-orange",
      "btn btn-outline-primary btn-bgc-white border-2 btn-text-danger btn-h-danger btn-a-danger",
    ],
  ...
  sidebarMatchings.lightpurple = jQuery.extend({}, sidebarMatchings.light, {
    ...
    nav: "",
    shortcuts: [
      "btn btn-outline-purple btn-bgc-white btn-h-success btn-a-success border-2 radius-2 btn-text-success",
      "btn btn-outline-purple btn-bgc-white btn-h-purple btn-a-purple border-2 radius-2 btn-text-purple",
      "btn btn-outline-purple btn-bgc-white btn-h-info btn-a-info border-2 radius-2 btn-text-info",
      "btn btn-outline-purple btn-bgc-white btn-h-orange btn-a-orange border-2 radius-2 btn-text-orange",
    ],
  ...
  sidebarMatchings.white4 = jQuery.extend({}, sidebarMatchings.light, {
    ...
    nav: "has-active-border active-on-right",
    shortcuts: [
      "btn btn-outline-success border-b-2 radius-round",
      "btn btn-outline-info border-b-2 radius-round",
      "btn btn-outline-warning border-b-2 radius-round",
      "btn btn-outline-danger border-b-2 radius-round",
    ],
  ...
  sidebarMatchings.dark = jQuery.extend({}, sidebarMatchings.light, {
    ...
    shortcuts: [
      "btn btn-outline-success border-b-2 btn-text-white",
      "btn btn-outline-info border-b-2 btn-text-white",
      "btn btn-outline-warning border-b-2 btn-text-white",
      "btn btn-outline-danger border-b-2 btn-text-white",
    ],
    ...
    "user-menu": [
      "bgc-black-tp8 btn-h-outline-blue",
      "bgc-black-tp8 btn-h-outline-purple",
      "bgc-black-tp8 btn-h-outline-orange",
    ],
  ...
  sidebarMatchings.steelblue = {
    ...
    "user-menu": [
      "bgc-black-tp8 btn-h-light-blue",
      "bgc-black-tp8 btn-h-light-purple",
      "bgc-black-tp8 btn-h-light-orange",
    ],
  ...
  sidebarMatchings.darkslategrey = jQuery.extend(
    {},
    sidebarMatchings.steelblue,
    {
      body: "body-darkslategrey",
  ...
  sidebarMatchings.darkslateblue = jQuery.extend(
    {},
    sidebarMatchings.steelblue,
    {
      body: "body-img1",
  ...
  sidebarMatchings.cadetblue = jQuery.extend({}, sidebarMatchings.steelblue, {
    ...
    shortcuts:
      "btn-bgc-white btn-h-outline-success btn-text-success btn-h-text-white border-2 radius-2",
  ...
  function applySidebarMatchingChanges($sidebar, theme) {
    ...
    if (
      currentBodyTheme == "auto" &&
      (currentBoxedLayout == "all" || currentBoxedLayout == "not-navbar")
    )
      $(document.body).addClass(changes["body"]);
    if (
      changes["navbar"] &&
      _allowAutoMatchNavbar &&
      $("#id-auto-match").prop("checked")
    ) {
    ...
    if (changes["sidebar-inner"])
      $sidebar.find(".sidebar-inner").addClass(changes["sidebar-inner"]);
    if (changes["nav"]) {
    ...
    var shortcuts = changes["shortcuts"] || [
      "btn-success opacity-2",
      "btn-info opacity-2",
      "btn-orange opacity-2",
      "btn-danger opacity-2",
    ];
    if (!Array.isArray(shortcuts) || shortcuts.length == 1)
      $sidebar
        ...
        .parent()
        .find(".btn")
        .addClass(!Array.isArray(shortcuts) ? shortcuts : shortcuts[0]);
    else {
      var p = $sidebar.find(".sidebar-shortcuts-mini").parent();
      for (var i = 0; i < 4; i++) {
        p.find(".btn:nth-child(" + (i + 1) + ")").addClass(
          shortcuts.length > i ? shortcuts[i] : shortcuts[i - shortcuts.length]
        );
      }
    }

    if (changes["exclamation"])
      $sidebar
        .find(".fa-exclamation-triangle")
        .addClass(changes["exclamation"]);
    if (changes["badge"])
      $sidebar.find(".badge:last").addClass(changes["badge"]);
    if (changes["search-icon"])
      $sidebar.find(".fa.fa-search").addClass(changes["search-icon"]);
    if (changes["mic-icon"])
      $sidebar.find(".fa.fa-microphone").addClass(changes["mic-icon"]);
    ...
    if (window.currentLayout == 2) {
      if (changes["brand"])
        $sidebar.find(".navbar-brand").addClass(changes["brand"]);
      if (changes["brand-icon"])
        $sidebar.find(".fa-leaf").addClass(changes["brand-icon"]);

      if (changes["user-img"])
        $sidebar.find("img").addClass(changes["user-img"]);
      if (changes["user-info"])
        $("#id-user-info a").addClass(changes["user-info"]);
      if (changes["user-desc"])
        $("#id-user-info div").addClass(changes["user-desc"]);
      ...
      if (!Array.isArray(usermenu) || usermenu.length == 1) {
        $("#id-user-menu .btn")
          ...
          .find(".fa")
          .addClass(
            !Array.isArray(usermenu_icons) ? usermenu_icons : usermenu_icons[0]
          );
      } else {
        for (var i = 0; i < 3; i++) {
          $("#id-user-menu .btn:nth-child(" + (i + 1) + ")")
            .addClass(
              usermenu.length > i ? usermenu[i] : usermenu[i - usermenu.length]
            )
            .find(".fa")
            .addClass(
              usermenu_icons.length > i
                ? usermenu_icons[i]
                : usermenu_icons[i - usermenu_icons.length]
            );
        }
      }
      ...
      if (changes["layout2-sidebar-footer"]) {
        ...
        footer
          .find(".btn")
          .addClass(
            changes["layout2-sidebar-footer-btn"] || "btn-blue btn-bold"
          );
      }
      ...
      if (!window.alertHidden)
        $.aceToaster.add({
          ...
          body:
            ...
            '<label class="d-block mt-3 mb-0 bgc-white-tp9 bgc-h-black-tp9 p-1 radius-2px"><input onchange="window.hideAlert()" id="hide-alert-' +
            window.currentLayout +
            '" type="checkbox" class="text-dark brc-dark border-2" /> Don\'t show this again</label>',

          width: 480,
          closeClass:
            "btn btn-xs btn-link no-underline bgc-h-black-tp8 text-white text-150 position-tr mr-n2",
          //delay: 8,
          sticky: true,
  ...
  navbarMatchings.blue = {
    ...
    "badge-bell":
      "badge-sm bgc-warning-d2 text-white text-80 border-1 brc-white-tp5",
    ...
    button:
      "btn-outline-default btn-h-white btn-a-white brc-white-tp3 btn-text-white",
  };
  ...
  function resetNavbarColors($navbar) {
    ...
    $navbar
      .find("#navbarMenu .navbar-nav > .nav")
      .removeClass(function (index, className) {
        var matchedClasses = className.match(
          /(^|\s)(nav-compact|border-0|has-active-border|mr-|m-|ml-|mx-)\S*/g
        );
        return (matchedClasses || []).join("");
      })
      .find("> .nav-item")
      ...
      .find("> a > .dropdown-caret")
      .removeClass("d-none");

    $navbar
      .find(
        ".navbar-brand, .navbar-brand span:last, .fa-leaf, .fa-search, .fa-flask, .fa-bell, #id-navbar-badge1, #id-navbar-badge2, .nav-user-name, #id-user-welcome, #navbarMenu .navbar-nav > .nav > .nav-item > .nav-link,  #navbarMenu .navbar-nav > .nav > .nav-item > .btn"
      )
      .removeClass(function (index, className) {
        var matchedClasses = className.match(
          /(^|\s)(btn-|bgc-|brc-|border-|text-|opacity-|m-|mx-|ml-|mr-|mt-|mb-|pl-|pr-|px-|p-|badge-)\S+/g
        );
        return (matchedClasses || []).join("");
      });
    ...
    //////////
    $navbar
      .find('[data-toggle="sidebar"] , [data-toggle-mobile="sidebar"]')
      .add($navbar.find(".fa-flask, .fa-bell").parent())
      .removeClass(function (index, className) {
        var matchedClasses = className.match(
          /(^|\s)(btn|btn-|brc-|text-|border-|(d-style))\S+/g
        );
        return (matchedClasses || []).join("");
      })
      .find(".bars")
    ...
    $navbar
      .find("#id-navbar-user-image , .navbar-toggler img")
      .removeClass(function (index, className) {
    ...
    //////////
    $navbar
      .find(".dropdown-mega > .dropdown-menu")
      .removeClass("mt-1px mt-0 border-t-0");
  ...
  function applyNavbarMatchingChanges($navbar, theme) {
    ...
    if (changes["nav-item"])
      nav.find("> .nav-item").addClass(changes["nav-item"]);
    ...
    if (changes["brand-icon"])
      brand.find(".fa-leaf").addClass(changes["brand-icon"]);
    if (changes["brand-subtext"])
      brand.find("span:last").addClass(changes["brand-subtext"]);

    if (changes["toggler"]) {
      var toggler = $navbar.find(
        '[data-toggle="sidebar"] , [data-toggle-mobile="sidebar"]'
      );
      toggler
        .addClass(
          Array.isArray(changes["toggler"])
            ? changes["toggler"][0]
            : changes["toggler"]
        )
        .addClass("btn-burger");
      if (typeof Array.isArray(changes["toggler"]) && changes["toggler"][1])
        toggler.find(".bars").addClass(changes["toggler"][1]);
    }

    if (changes["search"])
      $navbar.find('[data-target="#navbarSearch"]').addClass(changes["search"]);
    if (changes["navbar-input"])
      $navbar.find(".navbar-input").addClass(changes["navbar-input"]);
    if (changes["search-icon"])
      $navbar.find(".fa.fa-search").addClass(changes["search-icon"]);
    ...
    if (changes["nav-item-flask"]) {
      ...
      if (btnClass) {
        ...
        clone
          ...
          .eq(0)
          .addClass(
            btnClass[0].replace("outline-", "") +
              " radius-round w-4 h-4 text-center pt-2"
          );
      }
    ...
    if (changes["badge-bell"])
      $navbar.find("#id-navbar-badge1").addClass(changes["badge-bell"]);
    if (changes["badge-flask"])
      $navbar.find("#id-navbar-badge2").addClass(changes["badge-flask"]);

    if (changes["bell-icon"])
      $navbar.find(".fa-bell").addClass(changes["bell-icon"]);
    if (changes["flask-icon"])
      $navbar.find(".fa-flask").addClass(changes["flask-icon"]);

    if (changes["user-image"]) {
      $navbar
        .find("#id-navbar-user-image , .navbar-toggler img")
        .addClass(changes["user-image"]); //.find('.badge').removeClass('border-1');
    }

    if (changes["user-name"])
      $navbar.find(".nav-user-name").addClass(changes["user-name"]);
    if (changes["user-welcome"])
      $navbar.find("#id-user-welcome").addClass(changes["user-welcome"]);

    if (changes["mega"])
      $navbar.find(".dropdown-mega > .dropdown-menu").addClass(changes["mega"]);
    ...
    if (theme == "lightgrey") {
      ...
      cloned
        .removeClass("text-white-tp1")
        .addClass("text-dark-tp4 d-lg-none tmp--cloned")
        .find(".fa-leaf")
        .addClass("text-success-m1");
      ...
      cloned = bars
        .clone()
        .removeClass("text-white-tp1 d-none")
        .addClass("text-dark-tp4 d-lg-none tmp--cloned");
      bars.addClass("d-none d-lg-block").after(cloned);

      if (window.isAceLayout2) {
        $navbar
          .find(".btn-burger[data-toggle=sidebar]")
          .addClass("btn-light-success btn-bold")
          .find(".bars")
          .removeClass("text-white-tp1")
          .addClass("text-dark-tp4");
      }
    } else {
      $navbar
        .find(".navbar-brand , .btn-burger[data-toggle-mobile=sidebar] .bars")
        .removeClass("d-none d-lg-block");
    }
  ...
  function BoxedLayout(box) {
    ...
    if (box == "none") {
      $(".body-container, .navbar-inner, .page-content").removeClass(
      ...
      if (!window.isAceLayout2) {
        ...
        if ($(".navbar-inner > .container").length == 0)
  ...
  $(
    'link[rel=stylesheet][href*="/bootstrap.css"], link[rel=stylesheet][href*="/bootstrap.min.css"]'
  ).each(function () {
    var href = $(this).attr("href");
    $(this).attr(
      "data-rtl",
      href.indexOf(".min.css") == -1
        ? "./dist/css/rtl/bootstrap.css"
        : "./dist/css/rtl/bootstrap.min.css"
    );
  ...
  function loadCSS(href, message) {
    return new Promise(function (resolve, reject) {
      ...
      if (location.protocol == "file:") {
        ...
        overlay.innerHTML =
          '<div style="position: fixed !important; z-index: 2000; padding-top: 10rem;"\
						class="bgc-white position-tl w-100 h-100 text-center text-150 text-primary-m1">' +
          message +
          "</div>";
  ...
  function RTLLayout(rtl) {
    if (rtl) {
      ...
      $(
        ...
        try {
          loadCSS(href, "Loading RTL stylesheets ... please wait ...").then(
            function () {
              $(link).attr("href", href);
            }
          );
      ...
      $(document).on("shown.bs.popover.rtl", function (e, e2) {
        $(".bs-popover-right, .bs-popover-left").each(function () {
          var placement =
            this.className.indexOf("-right") >= 0 ? "right" : "left";
          if (placement == "right") {
      ...
      $(
        'link[rel=stylesheet][href*="/bootstrap.css"], link[rel=stylesheet][href*="/bootstrap.min.css"]'
      ).attr("href", bootstrapStylesheet);
      $(
        'link[rel=stylesheet][href*="/ace.css"],link[rel=stylesheet][href*="/ace.min.css"],link[rel=stylesheet][href*="/ace-themes.css"],link[rel=stylesheet][href*="/ace-themes.min.css"]'
      ).each(function () {
        $(this).attr(
          "href",
          $(this)
  ...
  function loadThemesFile() {
    var href = "";
    $(
      'link[rel=stylesheet][href*="/ace.css"],link[rel=stylesheet][href*="/ace.min.css"]'
    ).each(function () {
    ...
    try {
      loadCSS(href, "Loading themes stylesheet ... please wait ...").then(
        function () {
          addStylesheet(href);
        }
      );
  ...
  function ChangeFont(font) {
    ...
    var fonts = {
      ...
      raleway: {
        ...
        rules:
          "body.font-raleway { font-family: 'Raleway'; font-weight: 500; } .font-raleway .text-300, .font-raleway .font-light {font-weight: 400 !important;} .font-raleway .page-title {font-weight: 400 !important;}",
      },
      roboto: {
        name: "Roboto",
        url:
        ...
        rules:
          "body.font-roboto { font-family: 'Roboto'; letter-spacing: 0.5px; } body.font-roboto .text-600 , body.font-roboto .font-bolder, body.font-roboto .btn-bold, body.font-roboto .badge {font-weight: 500 !important;} body.font-roboto .sidebar .nav > .nav-item.active:not(.open) > .nav-link {font-weight: 500;}",
      },
      markazi: {
        name: "Markazi Text",
        url:
          "https://fonts.googleapis.com/css?family=Markazi+Text:400,500,600,700&display=swap&subset=arabic",
        rules:
          "body.font-markazi { font-family: 'Markazi Text'; } html.font-markazi {font-size: 18px;}",
      },
    };
